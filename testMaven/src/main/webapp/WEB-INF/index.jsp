			...
			<div class="main-layout-side">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  ...
				  <li class="layui-nav-item">
				    ...
				    <dl class="layui-nav-child">
				      <dd><a href="javascript:;" data-url="<%=basePath%>user/getAllUser.do" data-id='3' data-text="用户管理"><span class="l-line"></span>文章管理</a></dd>
				  ...
				  <li class="layui-nav-item">
				    <a href="javascript:user();" data-url="admin-info.html" data-id='5' data-text="个人信息"><i class="iconfont">&#xe606;</i>个人信息</a>
				  </li>
				  <li class="layui-nav-item">
			...
			<div class="main-layout-container">
				...
				<div class="main-layout-header">
					...
					<ul class="layui-nav" lay-filter="rightNav">
					  ...
					  <li class="layui-nav-item">
					    <a href="javascript:;" data-url="<%=basePath%>user/findadmininfo.do?username=${username }" data-id='5' data-text="${username }" >${username }</a>
					  </li>
					  <li class="layui-nav-item"><a href="<%=basePath%>user/login.do">退出</a></li>
					</ul>
				</div>
				<!--主体内容-->
					...
					<div class="layui-tab layui-tab-brief main-layout-tab" lay-filter="tab" lay-allowClose="true">
					  ...
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show" style="background: #f5f5f5;">
					    	<!--1-->
					    	<iframe src="<%=basePath%>part/channelPartnersInfo.do" width="100%" height="100%" name="iframe" scrolling="auto" class="iframe" framborder="0"></iframe>
					    	<!--1end-->
					    </div>
					  </div>
					</div>
